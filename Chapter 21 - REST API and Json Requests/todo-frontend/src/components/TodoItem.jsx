function TodoItem({
  ...
  return (
    <div
      className={`flex flex-col sm:flex-row items-center justify-between p-4 mb-3 rounded-lg border ${completed ? "bg-gray-50 border-gray-200" : "bg-white border-gray-200"
    ...
    >
      <div className="flex items-center mb-2 sm:mb-0 sm:flex-1">
        ...
        />
        <span
          className={`text-gray-700 font-medium ${completed ? "line-through text-gray-500" : ""
            }`}
        >
          {todoName}
        </span>
